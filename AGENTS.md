# tramite — instrucciones para Codex

## Triggers — cuando aplicar estas instrucciones

Aplicar cuando el usuario mencione: trámite, ANSES, jubilación, AUH, asignación, ARCA, AFIP, monotributo, facturación, vencimientos, clave fiscal, DNI, renovar documento, turno, registro automotor, patente, transferencia, VTV, obra social, burocracia argentina.
